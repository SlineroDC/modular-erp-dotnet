...
// Update the price in the readonly input when the dropdown changes
function updatePrice() {
    const select = document.getElementById('productSelect');
    // We get the price from the data-price attribute
...
function addToCart() {
    ...
    // Logic: If it already exists, increase quantity; otherwise, add new
    ...
    // Reset inputs for the next addition
    select.value = "";
...
// Send the sale to the server (Fetch API)
async function submitSale() {
    ...
    // This finds the hidden input generated by @Html.AntiForgeryToken()
